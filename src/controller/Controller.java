...
public class Controller {
	 ...
	 *
	 * @param nome,
	 *            String com o nome do aluno
	 * @param matricula,
	 *            String com a matricula do aluno
	 * @param codigoCurso,
	 *            Inteiro com o codigo unico referente ao curso
	 * @param telefone,
	 *            String com o numero de telefone do aluno
	 * @param email,
	 *            String com o email do aluno
	 * @throws NullPointerException
	 * @throws EmailInvalidoException
	 */
	public void cadastrarAluno(String nome, String matricula, int codigoCurso, String telefone, String email)
			throws Exception {
		if (!email.matches("[a-zA-Z0-9_.-]+@{1}[a-zA-Z0-9_.-]*\\.+[a-z]{2,4}")) {
	 ...
	 *
	 * @param matricula,
	 *            String que sera usada para busca o Aluno
	 * @return String
	 * @throws BuscaChaveException
	 *             Sera lancada quando o aluno pesquisado nao estiver cadastrado
	 */
	 ...
	 *
	 * @param matricula,
	 *            String com a matricula que identifica o Aluno
	 * @param atributo,
	 *            String com o atributo do Aluno pesquisado
	 * @return String
	 * @throws InfoException
	 *             Será lancada quando o Aluno pesquisado nao estiver matriculado
	 */
	 ...
	 *            String com a matricula que identifica o Aluno
	 * @param disciplina,
	 *            String com a disciplina que o Aluno sera tutor
	 * @param proficiencia,
	 *            Inteiro valor atribuido para a habilidade do Aluno da disciplina
	 * @throws Exception
	 * @throws Sera
	 *             lancada quando o Aluno pesquisado nao estiver cadastrado
	 */
	public void tornarTutor(String matricula, String disciplina, int proficiencia) throws Exception {
		...
		if (this.tutores.containsKey(matricula)) {
			...
			this.tutores.put(matricula,
					new Tutor(this.alunos.get(matricula), new Disciplina(disciplina, proficiencia)));
		}
	}
	 ...
	 *
	 * @param matricula,
	 *            String com o identificador unico do Tutor
	 * @return String
	 * @throws Sera
	 *             lancada caso o aluno/Tutor nao esteja cadastrado
	 * @throws BuscaChaveException
	 */
	 ...
	 *
	 * @param email,
	 *            String com o email do Tutor
	 * @param horario,
	 *            String com o horario disponivel
	 * @param dia,
	 *            String com o dia do atendimento
	 * @throws Sera
	 *             lancada caso o Tutor nao esteja cadastrado
	 ...
	 *            String com o email do Tutor
	 * @param local,
	 *            String com o local do atendimento
	 * @throws Sera
	 *             lancada se o tutor nao estiver cadastrado, ou algum parametro nao
	 *             for passado corretamente
	 ...
	 *            String com o email do Tutor
	 * @param horario,
	 *            String com o horario requerido para o novo atendimento
	 * @param dia,
	 *            String com o dia requerido para o novo atendimento
	 * @return boolean
	 */
	 ...
	 *            String com o email do Tutor
	 * @param local,
	 *            String com o local requerido para o novo atendimento
	 * @return boolean
	 */
